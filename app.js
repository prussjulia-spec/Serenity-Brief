  ...
  brief(
    ...
    [
      ...
      section("Дополнительные вводные", [
        ...
        choice("assets", "Какие материалы для рекламы уже готовы?", ["Фото", "Видео", "Креативы", "Тексты", "Товарный фид", "Каталог", "Брендбук", "Пока ничего"]),
        field("additional_links", "Если есть дополнительные сайты, соцсети или другие площадки — укажите ссылки.", "textarea"),
        field("additional", "Что важно знать о вашем бизнесе для этой задачи?", "textarea", "Ниша, регион, особенности продукта, ограничения, сезонность или другие важные детали."),
