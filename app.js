  ...
  brief(
    ...
    [
      ...
      section("Реклама сейчас", [
        ...
        field("analytics", "Какая аналитика и CRM уже подключены?", "textarea", "Метрика, Analytics, CRM, коллтрекинг"),
      ...
      section("Дополнительные вводные", [
        ...
        field("resources", "Есть ли разработчик или контент-менеджер для оперативных правок?", "textarea"),
        field("assets", "Какие материалы для рекламы уже готовы?", "textarea", "Фото, видео, креативы, товарный фид"),
        field("additional", "Есть ли другие сайты, продукты или вводные, которые важно учесть?", "textarea")
      ])
    ]
  ),
